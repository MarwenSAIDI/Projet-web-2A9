...
?>
    ...
    <body class="nav-md">
        ...
        function test() {
            ...
            if (document.myform.categorieproduit.value.length == 0) {
...
<div class="x_content">
                    <br />
                    <form method="post" name="myform" action=ajoutcategories.php>
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" >
                   
                   
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="idcategorie">id categorie  <span class="required">*</span>
                        </label>
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="categorieproduit">categorie produit <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text"  name="categorieproduit" required="required" class="form-control " >
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        <div class="col-md-6 col-sm-6 offset-md-3">
                          ...
                          <a href="afficher-categories.php"class="btn btn-primary">Annuler</a> 
