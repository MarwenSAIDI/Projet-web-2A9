                                            ...
                                            <div class="col-sm-12">
                                                <div class="card-box table-responsive">
                                                    ...
                                                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
	                                                   ...
	                                                   ?>
	                                                      <tr>
                                                                ...
                                                                <td><a href="ajouter-produits.php" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> </a>
                                                                <a href="modifier-produits.php" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> </a>
                                                                <a href="supprimer-produits.php" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>   </a></td>
                                                        </tr>
	                                                    <?PHP
}
                                                        ?>
                                                    ...
                                                    <form method="POST" action="rechercherproduit.php">
                                                                ...
                                                                <input value="<?PHP echo $row['idproduit']; ?>" name="idproduit" id="idproduit " class="btn btn-success" placeholder="id produit">
                                                     </form>
                                                     <form method="POST" action="trierproduits.php">
