                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <h3>Agent <small>Here you can manage your products</small></h3>
                            </div>
                                        ...
                                        <ul class="nav navbar-right panel_toolbox">
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="formulaire.php">Ajouter produit</a>
                                                    <a class="dropdown-item" href="supprimerproduit.php">Supprimer produit</a>
                                                    <a class="dropdown-item" href="modifierproduit.php">Modifier produit</a>
                                                </div>
                                            </li>
                                                    ...
                                                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
	                                                   ...
	                                                   ?>
	                                                      <tr>
	                                                            ...
	                                                            <td><?PHP echo $row['marqueproduit']; ?></td>
	                                                            <td><?PHP echo $row['quantiteproduit']; ?></td>
                                                                <td><?PHP echo $row['prixproduit']; ?></td>
                                                                <td><?PHP echo $row['code']; ?></td>
                                                                <td><a href="formulaire.php" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> Ajouter </a>
                                                                <a href="supprimerproduit.php" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Supprimer </a>
                                                                <a href="modifierproduit.php" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>  Modifier </a></td>
                                                        </tr>
	                                                    <?PHP
}
                                                        ?>
