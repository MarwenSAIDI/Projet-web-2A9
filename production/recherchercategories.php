	<?php
				...
				if (isset($_POST['idcategorie'])){
					$categorieproduit=$_POST["idcategorie"];
					$categorieproduit=$_POST["categorieproduit"];
				$categoriesC=new categorieC();
				$listecategories=$categoriesC->recherchercategories($idcategorie);
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <h3> <small>CECI EST LA CATEGORIE CHERCHE SELON SON ID</small></h3>
                            </div>
                                        ...
                                        <ul class="nav navbar-right panel_toolbox">
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="ajouter-categories.php">Ajouter categories</a>
                                                    <a class="dropdown-item" href="supprimer-categories.php">Supprimer categories</a>
                                                    <a class="dropdown-item" href="modifier-categories.php">Modifier categories</a>
                                                </div>
                                            </li>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="card-box table-responsive">
                                                    ...
                                                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
	                                                   ...
	                                                   ?>
	                                                      <tr>
																...
																<td><?PHP echo $row['categorieproduit']; ?></td>
	                                                          
	                                                         
                                                                <td><a href="ajouter-categories.php" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> Ajouter </a>
                                                                <a href="modifier-categories.php" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Modifier </a>
                                                                <a href="supprimer-categories.php" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>  Supprimer </a></td>
                                                        </tr>
	                                                    <?PHP
}}
                                                        ?>
                                                    ...
                                                    <a href="afficher-categories.php" class="btn btn-info btn-xs"><i "></i> RETOUR </a>
