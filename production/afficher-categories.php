                                                    ...
                                                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
	                                                   ...
	                                                   ?>
	                                                      <tr>
                                                                ...
                                                                <td><a href="ajouter-categories.php" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i>  </a>
                                                                <a href="modifier-categories.php" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>  </a>
                                                                <a href="supprimer-categories.php" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>  </a></td>
                                                        </tr>
	                                                    <?PHP
}
                                                        ?>
