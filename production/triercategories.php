...
$listecategories=$categorieC->triercategories();
									...
									<ul class="nav navbar-right panel_toolbox">
										...
										<li class="dropdown">
											...
											<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
												<a class="dropdown-item" href="ajouter-categories.php">Ajouter produit</a>
												<a class="dropdown-item" href="supprimer-categories.php">Supprimer produit</a>
												<a class="dropdown-item" href="modifier-categories.php">Modifier produit</a>
											</div>
										</li>
